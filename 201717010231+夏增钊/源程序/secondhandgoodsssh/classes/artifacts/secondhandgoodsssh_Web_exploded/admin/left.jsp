  ...
  if(admin.getUsertype().equals("管理员")){%>
    <div class="sidebar-nav">
        ...
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            ...
            <li><a href="admin/gameslist.jsp">公告管理</a></li>
            <li><a href="admin/aboutedit.jsp">使用指南</a></li>
...
<!-- <span class="label label-info">+3</span> -->
        ...
        <ul id="accounts-menu" class="nav nav-list collapse in">
            ...
            <li><a href="admin/ppinfo.jsp">品牌管理</a></li>
    ...
    <%}else{ %>
    <div class="sidebar-nav">
        <a href="#dashboard-menu" class="nav-header" data-toggle="collapse"><i class="icon-dashboard"></i>商品经手人功能<i class="icon-chevron-up"></i></a>
        <ul id="dashboard-menu" class="nav nav-list collapse in">
            <li><a href="admin/index.jsp">Home</a></li>
            <li><a href="admin/goodsgl.jsp">商品管理</a></li>
            <li><a href="admin/ddglforuser.jsp">商品订单</a></li>
            <li><a href="admin/thapplygl.jsp">退货商品</a></li>
