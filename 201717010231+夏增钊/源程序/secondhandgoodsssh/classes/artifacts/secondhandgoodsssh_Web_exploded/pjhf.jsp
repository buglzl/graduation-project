...
<html lang="en">
  <head>
    ...
    Pj pj = (Pj)dao.findByHql("from Pj where ddid="+ddid).get(0);%>
  <body>
		...
		<div class="container">
			...
			<div class="register">
				<div class="register-but">
				   <form name="f1" action="pjhf.action?id=<%=pj.getId() %>&ddid=<%=ddid %>" method="post">
				   <div class="register-top-grid">
						...
						<div class="input">
							<span>评价回复内容<label>*</label></span>
							<input type="text" class="form-control" placeholder="评价回复内容:" name="hf" id="hf" required>
						</div>
