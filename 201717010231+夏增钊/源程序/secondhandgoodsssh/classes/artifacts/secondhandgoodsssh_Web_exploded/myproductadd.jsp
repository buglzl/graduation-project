...
<div class="register">
				<div class="register-but">
				   <form name="f1" action="goodsadd.action" method="post" enctype="multipart/form-data">
				   <div>
						<%
						...
						<div class="input">
							...
							<input type="text" class="form-control" id="goodname" name="goodname" placeholder="商品名称 ..."  required>
						</div>
						<label></label>
						...
						<div class="input">
							...
							<input class="form-control" placeholder="商品价格 ..." type="number" step="0.1" id="price" name="price" class="input-xlarge" required>
						</div>
						<label></label>
						
						<div class="input">
							<span>商品图片<label>*</label></span>
							<input class="form-control" type="file" id="upFile" name="upFile" class="input-xlarge" required>
						</div>
						<label></label>
						...
						<div class="input">
							...
							<textarea class="form-control" id="editor_id" id="note" name="note" style="width:680px;height:400px;" ></textarea>
						</div>
