...
<div class="register">
				<div class="register-but">
				   <form name="f1" action="qiugouAdd.action?memberid=<%=m.getId() %>" method="post">
				   <div>
						<%
						...
						<div class="input">
							...
							<input type="text" class="form-control" id="goodsname" name="goodsname" placeholder="商品名称 ..."  required>
						</div>
						<label></label>
						
						<div class="input">
							<span>求购数量<label>*</label></span>
							<input class="form-control" placeholder="求购数量 ..." type="number"  id="num" name="num" class="input-xlarge" required>
						</div>
						<label></label>
						...
						<div class="input">
							...
							<textarea class="form-control" id="editor_id" id="content" name="content" style="width:680px;height:400px;" ></textarea>
						</div>
