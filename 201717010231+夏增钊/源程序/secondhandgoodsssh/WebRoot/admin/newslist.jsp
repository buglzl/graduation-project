...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommonDAO dao = (CommonDAO)Info.getDao(request,"CommonDAO");
	 String hql = " from News where 1=1 and type='公告'  ";
	 String url = "/secondhandgoodsssh/admin/newslist.jsp?1=1";
				...
				<div class="btn-toolbar">
					<div class="search-well">
						<form action="admin/newslist.jsp?f=f" method="post" class="form-inline">
						    ...
						    <button class="btn btn-primary" onclick="newsadd()" type="button"><i class="icon-plus"></i> 跑步知识</button>
						</form>	
					</div>  	
				</div>
...
<div class="well">
    <table class="table">
      ...
      <%String did = request.getParameter("did");
	   ...
	   PageManager pageManager = PageManager.getPage("/secondhandgoodsssh/admin/newslist.jsp?1=1",10, request);
