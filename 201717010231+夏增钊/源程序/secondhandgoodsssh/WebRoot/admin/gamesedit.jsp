...
Games news = (Games)dao.findById(id,"Games");
%>
  <body class="">
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="gamesedit.action?id=<%=id %>" method="post" >
		        <label>标题</label>
		        <input type="text" value="<%=news.getTitle() %>" id="title" name="title" class="input-xlarge span12" required>
		        <label>内容</label>
		        <script type="text/javascript" src="/secondhandgoodsssh/commfiles/js/calendar/WdatePicker.js"></script>
