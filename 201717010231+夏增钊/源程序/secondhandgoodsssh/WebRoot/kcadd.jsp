...
<div class="register">
				<div class="register-but">
				   <form name="f1" action="kcrecordAdd.action?gid=<%=id %>" method="post">
				   <input type="hidden" name="flag" value="<%=member.getId() %>"/>
				   <div>
						<%
						...
						<div class="input">
							...
							<input type="number" class="form-control" id="happennum" name="happennum" placeholder="数量 ..."  required>
						</div>
						<label></label>
